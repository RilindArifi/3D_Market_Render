...
<div>
    ...
    <div class="relative shadow-md sm:rounded-lg mt-3">
        ...
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                <tr  v-for="products in product" :key="products.id" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    <td class="p-4 w-4">
                        <div class="flex items-center">
                    ...
                    <td class="py-4 px-6">
                        <img :src="products.image" alt="" class="w-30 h-30">
                    </td>
                    <th scope="row" class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                        <p class="text-gray-500 dark:text-gray-400"><a :href="products.link" target="_blank" class="inline-flex items-center font-medium text-blue-600 dark:text-blue-500 hover:underline">
                            Check the link
                    ...
                    <td class="py-4 px-6">
                        ...
                        <el-button class="text-danger" text @click="open(products.id)"><i class="fa-solid fa-trash"></i></el-button>
                    </td>
                </tr>
            </tbody>
        </table>
