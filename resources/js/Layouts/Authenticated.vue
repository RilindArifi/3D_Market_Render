        ...
        <div>
            <div class="h-19.5">
                ...
                <a class="block px-8 py-6 m-0 text-size-sm whitespace-nowrap text-slate-700" href="javascript:;" target="_blank">
                    ...
                    <span class="ml-1 font-semibold transition-all duration-200 ease-nav-brand">3D Market Render</span>
                </a>
            </div>
            ...
            <div class="items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full">
                <ul class="flex flex-col pl-0 mb-0">
                    <li class="mt-0.5 w-full">
                        <Link  :href="route('dashboard')" :class="{ 'shadow-soft-xl bg-gradient-fuchsia rounded-lg text-white font-bold': $page.component.startsWith('BackEnd/Dashboard')}" class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="./pages/tables.html">
                            <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                                <img src="/assets/img/dashboard/dashboard.svg" alt="">
                            </div>
                            <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Dashboard</span>
                        </Link>
                    </li>
                    <li class="mt-0.5 w-full">
                        <Link  :href="route('category.index')" :class="{ 'shadow-soft-xl bg-gradient-fuchsia rounded-lg text-white font-bold': $page.component.startsWith('BackEnd/Category')}" class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors">
                            <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center fill-current stroke-0 text-center xl:p-2.5">
                                <img src="/assets/img/dashboard/category.svg" alt="">
                            </div>
                            <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Categories</span>
                        </Link>
                    </li>
                    <li class="mt-0.5 w-full">
                        <Link :href="route('category_sub.index')"  :class="{ 'shadow-soft-xl bg-gradient-fuchsia rounded-lg text-white font-bold': $page.component.startsWith('BackEnd/SubCategory')}" class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors">
                            <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                                <img src="/assets/img/dashboard/product.svg" alt="">
                            </div>
                            <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Category Sub</span>
                        </Link>
                    </li>
                    <li class="mt-0.5 w-full">
                        <Link :href="route('product.index')" :class="{ 'shadow-soft-xl bg-gradient-fuchsia rounded-lg text-white font-bold': $page.component.startsWith('BackEnd/Products')}" class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="./pages/virtual-reality.html">
                            <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
            ...
            <div class="flex items-center justify-between w-full px-4 py-1 mx-auto flex-wrap-inherit">
                <div class="flex justify-end">
                    <Link :href="route('home')"
                          class="bg-gradient-fuchsia inline-block px-8 py-2 mb-0 font-bold text-white text-center uppercase align-middle transition-all bg-transparent border border-solid rounded-lg shadow-none cursor-pointer leading-pro ease-soft-in text-size-xs bg-150 active:opacity-85 hover:scale-102 tracking-tight-soft bg-x-25 border-fuchsia-500 hover:opacity-75">
                        Go Home</Link>
                </div>
                        ...
                        <li class="flex items-center">
                            <div class="hidden sm:flex sm:items-center sm:ml-6">
                                ...
                                <span class="inline-flex rounded-md">
                                    <button type="button" class="inline-flex items-center px-3 py-2 border border-solid text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150 border border--600">
