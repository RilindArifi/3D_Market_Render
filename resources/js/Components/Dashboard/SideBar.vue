...
<template>
    <div>
        ...
        <ul class="flex flex-col pl-0 mb-0">
          ...
          <li class="mt-0.5 w-full">
            <Link :href="route('underproduct.index')" :class="{ 'shadow-soft-xl bg-gradient-fuchsia rounded-lg text-white font-bold': $page.component.startsWith('BackEnd/UnderProduct')}" class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors">
              <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                <img src="/assets/img/dashboard/product.svg" alt="">
              </div>
              <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Under Prodcuts</span>
            </Link>
          </li>
        <!--
